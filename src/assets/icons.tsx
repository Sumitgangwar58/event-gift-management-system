...
export const LogoutIcon = ({ size, color }: IconI) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={size ?? "24px"}
...
export const DashboardIcon = ({ size, color }: IconI) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={size ?? "24px"}
...
export const EventsIcon = ({ size, color }: IconI) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={size ?? "24px"}
...
export const CreateIcon = ({ size, color }: IconI) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={size ?? "24px"}
...
export const XIcon = ({ size, color }: IconI) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={size ?? "24px"}
...
export const DonateIcon = ({ size, color }: IconI) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={size ?? "24px"}
...
export const AddPeople = ({ size, color }: IconI) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={size ?? "24px"}
...
export const EyeOn = ({ size, color }: IconI) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={size ?? "24px"}
...
export const EyeOff = ({ size, color }: IconI) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={size ?? "24px"}
...
export const MenuIcon = ({ size, color }: IconI) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={size ?? "24px"}
